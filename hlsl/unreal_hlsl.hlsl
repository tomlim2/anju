...
void UpdateAllOperatorsCoverageTransmittance_FullySimplified(inout FStrataTree StrataTree) {}
void UpdateAllBSDFWithBottomUpOperatorVisit_FullySimplified(inout FStrataTree StrataTree) {}
#endif
// No Strata material provided
#if TEMPLATE_USES_STRATA
void PreUpdateAllBSDFWithBottomUpOperatorVisit(FStrataAddressing NullStrataAddressing, float3 V) {}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
    ...
    MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material.Texture2D_0,Material.Texture2D_0Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
    MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
    MaterialFloat3 Local4 = (Local2.rgb * ((MaterialFloat3)0.30000001));
...
void CalcPixelMaterialInputsAnalyticDerivatives(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
    ...
    MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
    MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(Texture2DSampleGrad(Material.Texture2D_0,Material.Texture2D_0Sampler,DERIV_BASE_VALUE(Local0),(Local0.Ddx)*exp2(View.MaterialTextureMipBias),(Local0.Ddy)*exp2(View.MaterialTextureMipBias)));
    MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
    MaterialFloat3 Local4 = (Local2.rgb * ((MaterialFloat3)0.30000001));
    MaterialFloat3 Local5 = lerp(Local4,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
