...
- 절차적 손그림 크리처 그리드(menagerie)는? → 독립 레포로 옮겼다: [goofy-procedural-creatures](https://github.com/tomlim2/goofy-procedural-creatures) (2026-08-19, `web/menagerie/`에서 히스토리째)
