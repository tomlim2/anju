...
export const GRID_BLOCK_POLICIES = [
  ...
  { footprint: "1x2", width: 1, height: 2, candidatePolicy: "mixed", requestedSizes: null, allowGraphic: true, align: "edge-derived", verticalAlign: "edge-derived", rotation: 90, orientationModes: ["whole-rotate"], cjkOrientationModes: ["glyph-sideways-stack"], englishOrientationModes: ["whole-rotate"], sizeSyncScope: null, xlargeWeight: null },
